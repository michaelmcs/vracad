				  ...
				  <div class="row">
					 <div class="col-md-12">
						  ...
						  <div class="form-group">
							<label for="date">Agregar código de programa</label><br>
								<input type="text" class="form-control" name="code" placeholder="Program Code" required>
								
						  </div><!-- /.form group -->
						    <div class="form-group">
							<label for="date">Título del programa</label><br>
				...
				<div id="form">
				  ...
				  <div class="row">
					 <div class="col-md-12">
						  ...
						  <div class="form-group">
							<label for="date">Actualizar <br> Código de programa</label><br>
						  ...
						  <div class="form-group">
							<label for="date">Nombre de programa</label><br>
