	      ...
	      <div class="col-md-8">
              <div class="box box-warning">
                   ...
                   <a href="#examt" data-target="#examt" data-toggle="modal" class="dropdown-toggle pull-right">
                    ...
                    <span style="font-size:18px;font-weight:bolder" class="pull-right">Imprimir calendario de exámenes &nbsp;</span><br><br>
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Busqueda de Horario del examen de la facultad
</h4>
              </div>
			  ...
			  <form class="form-horizontal" method="post" action="faculty_exam.php" target="_blank">
				...
				<div class="form-group">
					<label class="control-label col-lg-3" for="name">Facultad</label>
					<div class="col-lg-9">
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">×</span></button>
                <h4 class="modal-title"> búsqueda de Horario de examen de habitación 
</h4>
              </div>
              <div class="modal-body">
