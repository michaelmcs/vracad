      ...
      <div class="content-wrapper">
		...
		?>
							  <tr >
								...
								<td><input type="checkbox" name="j[]" value="<?php echo $id;?>" style="width: 20px; height: 20px;"></td>
								<td><input type="checkbox" name="v[]" value="<?php echo $id;?>" style="width: 20px; height: 20px;"></td>
                ...
                <div class="box-body">
				  ...
				  <div class="row">
					 <div class="col-md-12">
						  ...
						  <div class="form-group">
							<label for="date">Habitacion</label>
