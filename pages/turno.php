...
<html>
  <head>
    ...
    <title>turno | <?php include('../dist/includes/title.php');?></title>
  ...
  <body class="hold-transition skin-yellow layout-top-nav" onload="myFunction()">
    ...
    ?>
                <tr>
                <td>turno <?php echo $room;?></td>
                 
                <td><a id="click" href="turno.php?id=<?php echo $id;?>&turno=<?php echo $room;?>">
...
<?php }?>           
    ...
    <form method="post" action="turno_save.php">
		<div class="col-md-6">
