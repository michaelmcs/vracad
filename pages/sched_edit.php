      ...
      <div class="content-wrapper">
		...
		?>
							  <tr >
								...
								<td><input type="checkbox" name="j[]" value="<?php echo $id;?>" style="width: 20px; height: 20px;"
								<?php if(($id==$time_id) and ($day=='j')) echo "checked"; ?>></td>

								<td><input type="checkbox" name="v[]" value="<?php echo $id;?>" style="width: 20px; height: 20px;"
								<?php if(($id==$time_id) and ($day=='v')) echo "checked"; ?>></td>
            ...
            <div class="col-md-3">
              <div class="box box-warning">
               <?php
                ...
                <div class="box-body">
				  ...
				  <div class="row">
					 <div class="col-md-12">
						  ...
						  <div class="form-group">
							<label for="date">Haitacion</label>
				...
				</form>	<button class="uncheck btn btn-lg btn-block btn-success">Desmarcar todo</button>
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Buscar Horario de la Facultad</h4>
              </div>
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Buscar Horario de clase</h4>
              </div>
              <div class="modal-body">
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Buscar Horario de la habitación</h4>
              </div>
              <div class="modal-body">
			  <form class="form-horizontal" method="post" action="room_sched.php" target="_blank">
                
				<div class="form-group">
					<label class="control-label col-lg-2" for="name">habitación</label>
					<div class="col-lg-10">
