					 ...
					 <div class="col-md-12">
						 <form method="post" action="department_save.php"> 
						  <div class="form-group">
							<label for="date">Añadir código de departamento</label><br>
								<input type="text" class="form-control" name="code" placeholder="Department Code" required>
								
						  </div><!-- /.form group -->
						    <div class="form-group">
							<label for="date">Nonbre departamento</label><br>
				...
				<div id="form">
				  ...
				  <div class="row">
					 <div class="col-md-12">
						  ...
						  <div class="form-group">
							<label for="date">Actualizar <br> Codigo Departamento</label><br>
						  ...
						  <div class="form-group">
							<label for="date">Nombre departamento</label><br>
