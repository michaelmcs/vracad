                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group col-md-12">
                      <input type="text" class="form-control pull-right" id="date" name="name" placeholder="Nombre Ejemp: " required>
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
					  ...
					  <div class="form-group">
						...
						<div class="input-group col-md-12">
						  <input type="text" class="form-control pull-right" id="date" name="username" placeholder="usuario Ejemp: " required>
						</div><!-- /.input group -->
					  </div><!-- /.form group -->
						  ...
						  <div class="form-group">
							...
							<div class="input-group col-md-12">
							  <input type="password" class="form-control pull-right" id="date" name="password" placeholder="password Ejemp: " required>
							</div><!-- /.input group -->
						  </div><!-- /.form group -->
              <div class="form-group">
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Actualizar detalles del usuario</h4>
              </div>
			  ...
			  <form class="form-horizontal" method="post" action="user_update.php">
				...
				<div class="form-group">
					<label class="control-label col-lg-3" for="price">Nombre de usuario</label>
					<div class="col-lg-9">
				...
				<div class="form-group">
					<label class="control-label col-lg-3" for="price">Stado</label>
					<div class="col-lg-9">
