...
<table class="table table-bordered table-striped" style="margin-right:-10px">
    ...
    <?php
        ...
        $query=mysqli_query($con,"select * from grupo")or die(mysqli_error());
    ...
    ?>
                ...
                <td>
                <a id="click" href="grupo.php?id=<?php echo $id;?>&salut=<?php echo $salut;?>">
				  ...
				  <div class="row">
					 <div class="col-md-12">
						  ...
						  <div class="form-group">
							<label for="date">Agregar Seccion</label><br>
								<input type="text" class="form-control" name="name_sec" placeholder="Ejmp. A" required>
				...
				<div id="form">
				  ...
				  <div class="row">
					 <div class="col-md-12">
						  ...
						  <div class="form-group">
							<label for="date">Actualizar seccion</label><br>
								<input type="hidden" class="form-control" id="id" name="sec_id" value="<?php echo $_REQUEST['sec_id'];?>" readonly>
								<input type="text" class="form-control" id="class" name="name_sec" value="<?php echo $_REQUEST['name_sec'];?>" placeholder="Ejmp. A" required>
						  </div><!-- /.form group -->
					</div>
				  </div>	
