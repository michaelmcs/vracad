				  ...
				  <div class="row">
					 <div class="col-md-12">
						  ...
						  <div class="form-group">
							<label for="date">Añadir Designación</label><br>
								<input type="text" class="form-control" name="designation" placeholder="Designación" required>
				...
				<div id="form">
				  ...
				  <div class="row">
					 <div class="col-md-12">
						  ...
						  <div class="form-group">
							<label for="date">Designación de actualización</label><br>
