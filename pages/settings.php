            ...
            <div class="col-md-3">
              <div class="box box-warning">
                <div class="box-body">
				  ...
				  <div class="row">
					 <div class="col-md-12">
						  <h3>Agregar Configuraciones</h3>
						  <form method="post" action="settings_save.php">
						  <div class="form-group">
							<label for="date">Semestre</label><br>
						  ...
						  <div class="form-group">
							<label for="date">Año escolar</label><br>
