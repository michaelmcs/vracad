               ...
               <form method="post" id="reg-form">
                <div class="box-body">
					...
					<a href="#examroom" data-target="#examroom" data-toggle="modal" class="dropdown-toggle pull-right">
                      ...
                      <button class="btn btn-primary">Habitacion</button>				
                    </a>
					<a href="#examclass" data-target="#examclass" data-toggle="modal" class="dropdown-toggle pull-right">
                     
                      <button class="btn btn-success">Clase</button>				
                    </a>
                   <a href="#examt" data-target="#examt" data-toggle="modal" class="dropdown-toggle pull-right">
                     
                      <button class="btn btn-warning">Profesor</button>				
                    </a>
					<span style="font-size:18px;font-weight:bolder" class="pull-right">Imprimir calendario de exámenes &nbsp;</span>
                  <br><br>
					...
					<div class="col-md-12">
							...
							<thead>
							  <tr style="text-align:center">
								<th width="20%"  style="text-align:center">Tiempo</th>
								<th style="text-align:center">1er Dia</th>
								<th style="text-align:center">2do Dia</th>
								<th style="text-align:center">3rer Dia</th>
		...
		<div class="result" id="form">
            ...
            <div class="col-md-3">
              <div class="box box-warning">
                ...
                <div class="box-body">
				  ...
				  <div class="row">
					 <div class="col-md-12">
						  ...
						  <div class="form-group">
							<label for="date">Habitación</label>
				...
				</form>	<button class="uncheck btn btn-lg btn-success">Desmarcar todo</button>
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
              <div class="modal-header">
                ...
                <h4 class="modal-title">búsqueda de Calendario de exámenes de la facultad </h4>
              </div>
              ...
              <div class="modal-footer">
				<button type="submit" name="search" class="btn btn-primary">Mostrar horario</button>
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">×</span></button>
                <h4 class="modal-title">búsqueda  de Calendario de exámenes de clases </h4>
              </div>
              <div class="modal-body">
			  <form class="form-horizontal" method="post" action="class_exam.php" target="_blank">
                
				<div class="form-group">
					<label class="control-label col-lg-3" for="name">Clase</label>
					<div class="col-lg-9">
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">×</span></button>
                <h4 class="modal-title">búsqueda de Horario de examen de habitación  </h4>
              </div>
              <div class="modal-body">
			  <form class="form-horizontal" method="post" action="room_exam.php" target="_blank">
                
				<div class="form-group">
					<label class="control-label col-lg-3" for="name">Habitacion</label>
					<div class="col-lg-9">
